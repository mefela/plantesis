...
export default function ServicesSectionCircle() {
    ...
    useEffect(() => {
        ...
        handleResize(); // başlangıçta çağır
    ...
    return (
        ...
        >
            {/* Işınlar - masaüstü için */}
            <div className="hidden md:block absolute bottom-0 right-0 w-1/2 h-[2px] bg-gradient-to-l from-green-800 to-transparent opacity-45 pointer-events-none" />
            <div className="hidden md:block absolute bottom-0 right-0 h-1/2 w-[2px] bg-gradient-to-t from-green-800 to-transparent opacity-45 pointer-events-none" />
            <div className="hidden md:block absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-green-800 to-transparent opacity-45 pointer-events-none shadow-lg shadow-green-700" />
            <div className="hidden md:block absolute top-0 left-0 h-full w-[2px] bg-gradient-to-b from-green-800 to-transparent opacity-45 pointer-events-none shadow-lg shadow-green-500" />

            <motion.h2
                className="text-4xl md:text-5xl font-bold text-center text-green-800 mt-14 relative z-10"
